...
int main()
{
    ...
    unsigned char *data = stbi_load((path+"resources/textures/gdsc.jpg").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
...
prev_y =ypos;
        ...
        transform = glm::translate(transform, glm::vec3(input_x, input_y, 0.0f));
